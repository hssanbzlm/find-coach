<template>
   ...
   <CoachDetails :lastName="coach.lastName" :firstName="coach.firstName" :rate="coach.hourlyRate" class="mt-5">
   ...
   <template v-slot:areas>
        <BaseChip v-for="area in coach.areas" :key="area" color="red" text-color="white">
